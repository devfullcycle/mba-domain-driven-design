...
export class WaitingListEntryIdSchemaType extends Type<WaitingListEntryId, string> {
  convertToDatabaseValue(value: WaitingListEntryId | undefined): string {
    return value instanceof WaitingListEntryId ? value.value : (value as string);
  }
